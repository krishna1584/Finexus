...
public class AccountServiceImpl implements AccountService {
	...
	public Response createAccount(AccountDto accountDto) {
		...
		account.setAccountNumber(
				ACC_PREFIX + String.format("%07d", sequenceService.generateAccountNumber().getAccountNumber()));
	...
	public Response updateAccount(String accountNumber, AccountDto accountDto) {
		...
		return accountRepository.findAccountByAccountNumber(accountDto.getAccountNumber()).map(account -> {
