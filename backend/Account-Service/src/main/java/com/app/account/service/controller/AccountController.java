...
public class AccountController {
	...
	public ResponseEntity<List<AccountDto>> readAllAccountsByUserId(@PathVariable Long userId) {
		return ResponseEntity.ok(accountService.readAllAccountsByUserId(userId));
	}
